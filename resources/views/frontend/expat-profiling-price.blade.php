            ...
            <div class="row pt-lg-5 pt-xl-4 pt-1">
                <div class="col-lg-6 col-md-12" data-aos="fade-right" data-aos-duration="1500">
                    ...
                    <div class="banner_text profiling">
                        ...
                        <p>
                            Prepare for your expatriation with our comprehensive and data-driven assessment profiling tool.
                            Receive a personalized report highlighting your strengths, potential challenges, and tailored
                            strategies for you as an expat. Our tool offers actionable recommendations and expert advice,
                            equipping you with the knowledge and self-awareness to navigate the complexities of expat life.
                            Complete our brief assessment today and gain valuable insight to start your journey.
                        </p>
                        <ul class="">
                            <li class="m-0  pt-3 d-sm-flex ">
                                ...
                                <div class="text-center d-inline px-3"><span
                                        class="d-sm-block d-none p-0 m-0">S$300.00</span>
                                    <span class="d-sm-block d-none p-0 m-0 f-s-12">Per Profile</span>
                                </div>
                            </li>
                            <div class=" l-h-18 mt-2 text-center custom-align"><span
                                    class="d-sm-none d-block p-0 m-0">S$300.00</span>
                                <span class="d-sm-none d-block p-0 m-0 f-s-12">Per Profile</span>
                            </div>
                        </ul>
                    </div>
                    <!-- app buttons -->
            ...
            <div class="container">
                <div class="section_title" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                    ...
                    <div class="row px-md-5">
                        ...
                        <div class="col-6 text-right d-md-block d-none">
                            ...
                            <div class=" l-h-18 mt-2 text-end "><span class="d-none d-md-block p-0 m-0">S$300.00</span>
                                <span class="d-none d-md-block p-0 m-0 f-s-12">Per Profile</span>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center px-md-5 who-is-it-for">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="hover-container">
                            <img loading="lazy"  src="{{ asset('frontend/images/who/spouse-2.WEBP') }}" alt="Avatar" class="image"
                                style="width:100%">
                            <div class="middle ">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="hover-container">
                            <img loading="lazy"  src="{{ asset('frontend/images/who/family-2.WEBP') }}" alt="Avatar" class="image"
                                style="width:100%">
                            <div class="middle ">
                    ...
                    <div class="col-md-6 col-lg-4 mt-lg-2">
                        ...
                        <div class="hover-container">
                            <img loading="lazy"  src="{{ asset('frontend/images/who/young-2.WEBP') }}" alt="Avatar" class="image"
                                style="width:100%">
                            <div class="middle ">
                ...
                <div class="text-center mt-4 mb-lg-0 mb-4 d-md-none d-block">
                    ...
                    <div class=" l-h-18 mt-2 text-end  "><span class="d-md-none d-block p-0 m-0">S$300.00</span>
                        <span class="d-md-none d-block p-0 m-0 f-s-12">Per Profile</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="text-lg-left text-center mt-lg-3 mt-4 mb-lg-0 mb-sm-4 d-sm-flex">
                        <a href="https://expatadvising.com/sc-bridge/orders/SbjHdEASceFJfZxp" target="_blank"
                            class="btn puprple_btn get-started">Get Access <svg width="17" height="16" viewBox="0 0 17 16"  xmlns="http://www.w3.org/2000/svg" class="chclr">
                                    <path d="M0.5 6.99996V8.99996H12.5L7 14.5L8.42 15.92L16.34 7.99996L8.42 0.0799561L7 1.49996L12.5 6.99996H0.5Z" />
                                    </svg> </a>
                        <div class="text-center d-inline px-3"><span class="d-sm-block d-none p-0 m-0">S$300.00</span>
                            <span class="d-sm-block d-none p-0 m-0 f-s-12">Per Profile</span>
                        </div>
                    </div>
                    <div class=" l-h-18 mt-2 mb-4 text-center custom-align"><span
                            class="d-sm-none d-block p-0 m-0">S$300.00</span>
                        <span class="d-sm-none d-block p-0 m-0 f-s-12">Per Profile</span>
                    </div>
                </div>
                <div class="col-lg-6 d-lg-block d-none">
                    ...
                    <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
                        <div class="">
                            <img loading="lazy"  class="moving_position_animatin w-100" src="{{ asset('frontend/images/feature.WEBP') }}"
                                alt="image">
                        </div>
                        <!-- UI Image -->
                    </div>
                ...
                <div class="row px-md-2">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about_text">
                            ...
                            <div class="text-lg-left text-center  d-sm-flex">
                                <a href="https://expatadvising.com/sc-bridge/orders/SbjHdEASceFJfZxp" target="_blank"
                        ...
                        <div class="testimonial_slide_box">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-8 order-lg-2 order-1">
                                    ...
                                    <p class="review">
                                        “The profile was spot on! it validated many of the things I thought I knew about
                                        myself but
                                        wasn't quite sure, and it led to greater insights into what that means for me in
                                        terms of
                                        succeeding in a global environment. The strategies in the report are helpful to take
                                        the
                                ...
                                <div class="col-lg-8 order-lg-2 order-1 ">
                                    ...
                                    <div id="profile-description" class="pb-lg-0 pb-2">
                                        <div class="text show-more-height">
                                            <p class="review mb-xl-0">“ I did the Expat Profile on my own and then the
                                                Family Profile with my wife. The Expat
                                                Profile helped me understand my strengths and weaknesses in the context of
                                                global
                                                assignments. It also provided me and my HR with strategies to ensure my
                                                success. Succinct
                                                but yet comprehensive in its approach! A very valuable tool for me and my
                                                HR.<br>
                                                The Expat Family Profile triggered conversations between my wife and me on
                                                how we intend to
                                                approach the relocation. It helped ensure that we were aligned in our
                                                thinking. This was
                                                further supplemented by the Expat Advising Conversation Game. The report was
                                                very helpful to
                                                think through our strategies as a couple and as a family that was moving to
                                                another culture
                                                with 2 young kids. I highly recommend this assessment for any move involving
                                                a partner
                        ...
                        <div class="testimonial_slide_box">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-8 order-lg-2 order-1">
                                    ...
                                    <p class="review">
                                        “ So much makes sense now! I have been an expat spouse for over 6 years now. Some of
                                        it was easy, and some of it was extremely challenging. I wasn't quite sure why! Now
                                        I know! So much makes sense! Thank you Expat Advising for shedding light on what was
                                        going on, what to expect and how best to deal with the challenges.”
                                    </p>
                                </div>
                                <div class="col-lg-4 order-lg-1 order-2">
                ...
                <div class="accordion" id="accordionExample">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                ...
                                <div class=" l-h-18 mt-0  text-center custom-align"><span
                                        class="d-sm-none d-block p-0 m-0">S$300.00</span>
                                    <span class="d-sm-none d-block p-0 m-0 f-s-12">Per Profile</span>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                            data-parent="#accordionExample">
                            <div class="card-body">
                                <p>The report describes you as an expat. It provides your key characteristics, your
                                    strengths and weaknesses, opportunities, suggested roles, and strategies for you to
                                    thrive as an expat.
                                </p>
                                <div class="text-md-left text-center d-sm-flex">
                                    <a href="https://expatadvising.com/sc-bridge/orders/SbjHdEASceFJfZxp" target="_blank"
