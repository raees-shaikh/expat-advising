    @extends('frontend.layouts.app')
      ...
      @section('gtag')
      <script async src="https://www.googletagmanager.com/gtag/js?id=G-X25T3VZMJQ"></script>
      <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-X25T3VZMJQ');
      </script>
      @endsection
        @section('content')
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center  pt-4">
                            ...
                            <p class="m-0 ">Your one-stop destination for a multitude of videos offering you invaluable
                                insights, strategies, and practical wisdom to excel in
                                your expat experience.</p>
                            <p class="m-0 ">Prepare for your successful expatriations with our library of on-demand videos
                                and downloadable tools in the Expat Video Academy.</p>


                            <div class="my-3">
                                <a href="https://expatadvising.com/sc-bridge/plans/cF6vQmB5ZmLVL3md" target="_blank"
                                    class="btn puprple_btn get-started">Get Access <svg width="17" height="16"
                                        viewBox="0 0 17 16" xmlns="http://www.w3.org/2000/svg" class="chclr">
                                        <path
                                            d="M0.5 6.99996V8.99996H12.5L7 14.5L8.42 15.92L16.34 7.99996L8.42 0.0799561L7 1.49996L12.5 6.99996H0.5Z" />
                                    </svg> </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pt-lg-5 pt-xl-4 pt-1">
                        <div class="col-lg-6 col-md-12 pt-lg-4" data-aos="fade-right" data-aos-duration="1500">
                            ...
                            <div class="banner_text">
                                ...
                                <h1 class="text-capitalize banner-title-font mb-2 text-lg-left text-center">Expat Video
                                    Academy </h1>
                                ...
                                <p>
                                    Get ready for your new life abroad with our comprehensive on-demand videos and essential
                                    tools. The Expat Video Academy is your one-stop destination for a multitude of videos,
                                    offering you invaluable insights. From relocation tips to thriving in a new country – we
                                    have got you covered!

                                </p>
                                <ul class="  pt-3 text-lg-left text-center">
                                    <li class="m-0 d-sm-flex align-items-center">
                                        <a href="https://expatadvising.com/sc-bridge/plans/cF6vQmB5ZmLVL3md" target="_blank"
                                            class="btn puprple_btn get-started">Get Started <svg width="17"
                                                height="16" viewBox="0 0 17 16" xmlns="http://www.w3.org/2000/svg"
                                                class="chclr index">
                                                <path
                                                    d="M0.5 6.99996V8.99996H12.5L7 14.5L8.42 15.92L16.34 7.99996L8.42 0.0799561L7 1.49996L12.5 6.99996H0.5Z" />
                                            </svg> </a>
                                        <div class="px-3 l-h-18 text-center"><span
                                                class="d-sm-block d-none p-0 m-0">S$300.00</span>
                                            <span class="d-sm-block d-none p-0 m-0 f-s-12">For 6 Months</span>
                                        </div>
                                        <div class="px-2 l-h-18 mt-2 text-center"><span
                                                class="d-sm-none d-block p-0 m-0">S$300.00</span>
                                            <span class="d-sm-none d-block p-0 m-0 f-s-12">For 6 Months</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-12 d-lg-block d-none" data-aos="fade-in" data-aos-duration="1500">
                            <div class="banner_slider">
                                ...
                                <img loading="lazy"  src="{{ asset('frontend/images/banner-1.WEBP') }}" alt=""
                                    class="w-100after-lg">
                            </div>
                        </div>
                        <!-- banner slides end -->
            ...
            <section class="row_am why_we_section pt-0 pb-4 position-relative" data-aos="fade-in">
                ...
                <div class="why_inner pb-xl-5 pb-4 pt-md-4 pt-0">
                    <div class="container">
                        <div class="section_title" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                            ...
                            <div class="row px-md-5">
                                ...
                                <div class="col-6 text-right d-md-block d-none">
                                    <a href="https://expatadvising.com/sc-bridge/plans/cF6vQmB5ZmLVL3md" target="_blank"
                                        class="btn puprple_btn get-started">Get Access Now <svg width="17"
                                            height="16" viewBox="0 0 17 16" xmlns="http://www.w3.org/2000/svg"
                                            class="chclr">
                                            <path
                                                d="M0.5 6.99996V8.99996H12.5L7 14.5L8.42 15.92L16.34 7.99996L8.42 0.0799561L7 1.49996L12.5 6.99996H0.5Z" />
                                        </svg> </a>
                                    <div class="px-3 l-h-18 text-end mt-2"><span
                                            class="d-md-block d-none p-0 m-0">S$300.00</span>
                                        <span class="d-sm-block d-none p-0 m-0 f-s-12">For 6 Months</span>
                                    </div>
                        ...
                        <div class="row justify-content-center px-md-5 who-is-it-for">
                            <div class="col-md-6 col-lg-4 ">
                                ...
                                <div class="hover-container">
                                    <img loading="lazy"  src="{{ asset('frontend/images/who/1.WEBP') }}" alt="Avatar" class="image"
                                        style="width:100%">
                                    <div class="middle ">
                            ...
                            <div class="col-md-6 col-lg-4">
                                ...
                                <div class="hover-container">
                                    <img loading="lazy"  src="{{ asset('frontend/images/who/spouse-1.WEBP') }}" alt="Avatar"
                            ...
                            <div class="col-md-6 col-lg-4">
                                ...
                                <div class="hover-container">
                                    <img loading="lazy"  src="{{ asset('frontend/images/who/family-1.WEBP') }}" alt="Avatar"
                                        class="image" style="width:100%">
                                    <div class="middle ">
                            ...
                            <div class="col-md-6 col-lg-4 mt-lg-2">
                                ...
                                <div class="hover-container">
                                    <img loading="lazy"  src="{{ asset('frontend/images/who/young-1.WEBP') }}" alt="Avatar"
                                        class="image" style="width:100%">
                                    <div class="middle ">
                            ...
                            <div class="col-md-6 col-lg-4 mt-lg-2">
                                ...
                                <div class="hover-container">
                                    <img loading="lazy"  src="{{ asset('frontend/images/who/5.WEBP') }}" alt="Avatar" class="image"
                                        style="width:100%">
                                    <div class="middle ">
                            ...
                            <div class="col-md-6 col-lg-4 mt-lg-2">
                                ...
                                <div class="hover-container">
                                    <img loading="lazy"  src="{{ asset('frontend/images/who/repa-2.WEBP') }}" alt="Avatar"
                                        class="image" style="width:100%">
                                    <div class="middle ">
                        ...
                        <div class="text-center mt-4 mb-lg-0 mb-4 d-md-none d-block">
                            <a href="https://expatadvising.com/sc-bridge/plans/cF6vQmB5ZmLVL3md" target="_blank"
                                class="btn puprple_btn get-started">Get Access Now <svg width="17" height="16"
                                    viewBox="0 0 17 16" xmlns="http://www.w3.org/2000/svg" class="chclr">
                                    <path
                                        d="M0.5 6.99996V8.99996H12.5L7 14.5L8.42 15.92L16.34 7.99996L8.42 0.0799561L7 1.49996L12.5 6.99996H0.5Z" />
                                </svg> </a>
                            <div class="px-3 l-h-18 text-end mt-2"><span class="d-md-none d-block p-0 m-0">S$300.00</span>
                                <span class="d-md-none d-block p-0 m-0 f-s-12">For 6 Months</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <ul class="design_block mt-lg-0 mt-0">
                                            ...
                                            <li data-aos="fade-up" data-aos-duration="1500"
                                                ...
                                                <img loading="lazy"  src="{{ asset('frontend/images/right_icon.WEBP') }}"
                                                    class="right-icon">
                            ...
                            <div class=" text-lg-left  text-center mt-lg-3 mt-4 mb-lg-0 mb-4 d-sm-flex align-items-center">
                                <a href="https://expatadvising.com/sc-bridge/plans/cF6vQmB5ZmLVL3md" target="_blank"
                                    class="btn puprple_btn get-started">Get Access <svg width="17" height="16"
                                        viewBox="0 0 17 16" xmlns="http://www.w3.org/2000/svg" class="chclr">
                                        <path
                        ...
                        <div class="row px-md-1 ">
                            <div class="col-lg-6 d-lg-block d-none">
                                ...
                                <div class="about_img" data-aos="fade-in" data-aos-duration="1500">
                                    <div class="frame_img">
                                        <img loading="lazy"  class="moving_position_animatin"
                                            src="{{ asset('frontend/images/expat-2.WEBP') }}" alt="image">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="about_text">
                                    ...
                                    <div class="about_img d-lg-none d-block mb-4 text-lg-left text-center"
                                    ...
                                    <ul class="app_statstic" id="counter" data-aos="fade-in" data-aos-duration="1500">
                                        <li>
                                            ...
                                            <div class="text">
                                                ...
                                                <p>Only 60% of expatriations are well prepared and they succeed. Ensure you
                                                    are one of them with the videos in the Expat Video Academy</p>
                                            </div>
                                        </li>
                                        <li>
                                    ...
                                    <div class="text-lg-left text-center d-sm-flex align-items-center">
                                        <a href="https://expatadvising.com/sc-bridge/plans/cF6vQmB5ZmLVL3md"
                                            target="_blank" class="btn puprple_btn get-started ">Buy Now <svg
                                                width="17" height="16" viewBox="0 0 17 16"
                                                xmlns="http://www.w3.org/2000/svg" class="chclr">
                                                <path
                                                    d="M0.5 6.99996V8.99996H12.5L7 14.5L8.42 15.92L16.34 7.99996L8.42 0.0799561L7 1.49996L12.5 6.99996H0.5Z" />
                                            </svg> </a>
                                        <div class="px-3 l-h-18 text-center"><span
            ...
            <section class="px-xl-2">
                <div class="container ">
                    <div class="row text-center section_title ">
                        ...
                        <div class="video-div "><video class="video-frame" width="420" height="315"
                                src="{{ asset('frontend/videos/2.9 Adaptation and integration - expat life cycle.mp4') }}"
                                frameborder="0" allowfullscreen controls playsinline
                                poster="{{ asset('frontend/images/video-img.WEBP') }}"></video></div>
            ...
            <section class="">
                <section class="row_am testimonial_section grey-bg mx-xl-3 position-relative mt-5">
                    ...
                    <div class="container p-sm-0 p-2">
                        <div class="section_title pt-md-0 pt-2 pb-sm-0 pb-2" data-aos="fade-up" data-aos-duration="1500"
                            data-aos-delay="300">
                            <!-- h2 -->
                                    ...
                                    <div class="testimonial_slide_box">
                                        <div class="row align-items-center">
                                            <div class="col-lg-8 order-lg-2 order-1">
                                                ...
                                                <p class="review">
                                                    “I consider myself a veteran expat. I have lived abroad for over 10
                                                    years. And yet, with the
                                                    different phases of life, I found myself dealing with new challenges. It
                                                    all began to make
                                                    sense when I watched the videos on the Expat Video Academy. Suddenly, it
                                                    all clicked! I
                                                    was largely, as they say, winging it! But not anymore. I am now
                                                    expatriating again, with my
                                                    eyes wide open, and with additional knowledge and skills. ”
                                                </p>
                                            </div>
                                            <div class="col-lg-4 order-lg-1 order-2">
                                                <div class="testimonial_img">
                                                    <img loading="lazy"  src="{{ asset('frontend/images/real.WEBP') }}" alt="image">
                                                </div>
                                    ...
                                    <div class="testimonial_slide_box">
                                        ...
                                        <div class="row align-items-center pt-xl-4">
                                            <div class="col-lg-8 order-lg-2 order-1">
                                                ...
                                                <p class="review">
                                                    “ I managed to get a major bump with my expat package. This is all
                                                    thanks to the Academy and 1:1 sessions with Expat Academy. Next step,
                                                    financial planning! I am learning so much from the videos as well as the
                                                    Expat Advising experts.”
                                                </p>
                                            </div>
                                            <div class="col-lg-4 order-lg-1 order-2">
                                                <div class="testimonial_img">
                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        <p>The Expat Video Academy is an online 24/7 available portfolio of videos providing
                                            you with comprehensive knowledge, guidance, and solutions on every aspect of
                                            expat life.</p>
                                        <div class="text-md-left text-center d-sm-flex align-items-center">
                                            ...
                                            <div class="px-3 l-h-18 text-center pb-sm-3"><span
                                                    class="d-sm-block d-none p-0 m-0">S$300.00</span>
                                                <span class="d-sm-block d-none p-0 m-0 f-s-12">For 6 Months</span>
                                            </div>
                                            <div class="px-2 l-h-18 mt-0 text-center"><span
                                                    class="d-sm-none d-block p-0 m-0">S$300.00</span>
                                                <span class="d-sm-none d-block p-0 m-0 f-s-12">For 6 Months</span>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button type="button" class="btn btn-link collapsed" data-toggle="collapse"
                                            data-target="#collapseTwo"><i class="icon_faq icofont-plus"></i></i>Who can
                                            benefit
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                    data-parent="#accordionExample">
                                    <div class="card-body">
                                        <p>The Academy is designed for both expats and repats, whether you're moving for
                                            work,
                                            study, or personal reasons. It caters to individuals at all stages of their
                                            expat
                                            journey i.e., before, during, and after expatriation as well as before and after
                                            repatriation. It is also beneficial for HR professionals, relocation
                                            specialists, career
                                            coaches, counselors, consultants, and anyone involved in supporting expats
                                            during their
                            ...
                            <div class="card">
                                ...
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                    data-parent="#accordionExample">
                                    <div class="card-body">
                                        <p>The Expat Video Academy covers a wide range of topics with practical insights,
                                            best
                                            practices, and tools to address the unique challenges faced by expats and their
                                            families. Some of the many topics that apply to most expats include the
                                            different stages
                                            of the expat life cycle and how to prepare for each stage, culture shock and
                                            reverse
                                            culture shock, expat blues, how to negotiate a competitive expat contract,
                                            imposter
                                            syndrome, etc. Some of the many nuanced topics include dating as an expat (if
                                            you are
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                    data-parent="#accordionExample">
                                    <div class="card-body">
                                        <p>It is completely self-paced, allowing you to progress through the material at
                                            your
                                            convenience and preferred pace. Anytime, anywhere. However, there may be
                                            opportunities
                                            for expert-led sessions or webinars to foster interaction and address specific
                                            topics.
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                    data-parent="#accordionExample">
                                    <div class="card-body">
                                        <p>You can enroll on our website right now. Subscribe for 6-months at SGD 300 / EUR
                                            225.
                                            Subsequent 6-months renewal is subsidized at SGD 200 / EUR 125. For shorter
                                            subscription
